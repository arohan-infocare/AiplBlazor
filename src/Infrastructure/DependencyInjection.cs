...
using AiplBlazor.Application.Common.Interfaces.MultiTenant;
using AiplBlazor.Application.Common.Models;
using AiplBlazor.Domain.Identity;
using AiplBlazor.Infrastructure.Configurations;
using AiplBlazor.Application.Common.Security;
using AiplBlazor.Infrastructure.Persistence.Interceptors;
using AiplBlazor.Infrastructure.Services.Circuits;
using AiplBlazor.Infrastructure.Services.Gemini;
using AiplBlazor.Infrastructure.Services.MultiTenant;
...
using AiplBlazor.Application.Common.Constants;

namespace AiplBlazor.Infrastructure;
public static class DependencyInjection
{
    ...
    private const string POSTGRESQL_MIGRATIONS_ASSEMBLY = "AiplBlazor.Migrators.PostgreSQL";
    private const string MSSQL_MIGRATIONS_ASSEMBLY = "AiplBlazor.Migrators.MSSQL";
    private const string SQLITE_MIGRATIONS_ASSEMBLY = "AiplBlazor.Migrators.SqLite";
