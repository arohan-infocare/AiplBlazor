    ...
    public static void RegisterSerilog(this WebApplicationBuilder builder)
    {
        ...
        builder.Host.UseSerilog((context, configuration) =>
            configuration.ReadFrom.Configuration(context.Configuration)
                ...
                .MinimumLevel.Override("AiplBlazor.Server.UI.Services.Fusion.UserSessionTracker", LogEventLevel.Error)
                .MinimumLevel.Override("AiplBlazor.Server.UI.Services.Fusion.OnlineUserTracker", LogEventLevel.Error)
